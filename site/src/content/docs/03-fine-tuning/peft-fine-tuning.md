...
skillName: "peft-fine-tuning"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Fine-Tuning", "PEFT", "LoRA", "QLoRA", "Parameter-Efficient", "Adapters", "Low-Rank", "Memory Optimization", "Multi-Adapter"]
skillDeps: ["peft>=0.13.0", "transformers>=4.45.0", "torch>=2.0.0", "bitsandbytes>=0.43.0"]
---
