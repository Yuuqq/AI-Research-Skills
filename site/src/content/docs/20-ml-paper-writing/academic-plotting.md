...
skillName: "academic-plotting"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Academic Writing", "Visualization", "Matplotlib", "Seaborn", "Plotting", "Figures", "Diagrams", "NeurIPS", "ICML", "ICLR", "LaTeX"]
skillDeps: ["matplotlib>=3.8.0", "seaborn>=0.13.0", "numpy", "google-genai>=1.0.0"]
---
