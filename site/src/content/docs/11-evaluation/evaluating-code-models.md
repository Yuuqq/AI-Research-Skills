...
skillName: "evaluating-code-models"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Evaluation", "Code Generation", "HumanEval", "MBPP", "MultiPL-E", "Pass@k", "BigCode", "Benchmarking", "Code Models"]
skillDeps: ["bigcode-evaluation-harness", "transformers>=4.25.1", "accelerate>=0.13.2", "datasets>=2.6.1"]
---
