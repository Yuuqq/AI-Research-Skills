...
skillName: "experiment-tracking-swanlab"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["MLOps", "SwanLab", "Experiment Tracking", "Open Source", "Visualization", "PyTorch", "Transformers", "PyTorch Lightning", "Fastai", "Self-Hosted"]
skillDeps: ["swanlab>=0.7.11", "pillow>=9.0.0", "soundfile>=0.12.0"]
---
