...
skillName: "grpo-rl-training"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Post-Training", "Reinforcement Learning", "GRPO", "TRL", "RLHF", "Reward Modeling", "Reasoning", "DPO", "PPO", "Structured Output"]
skillDeps: ["transformers>=4.47.0", "trl>=0.14.0", "datasets>=3.2.0", "peft>=0.14.0", "torch"]
---
