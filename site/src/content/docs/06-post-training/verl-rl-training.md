...
skillName: "verl-rl-training"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Reinforcement Learning", "RLHF", "GRPO", "PPO", "Post-Training", "Distributed Training"]
skillDeps: ["verl>=0.3.0", "torch>=2.0.0", "ray>=2.41.0", "vllm>=0.8.2", "transformers>=4.40.0"]
---
