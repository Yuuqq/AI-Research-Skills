...
skillName: "miles-rl-training"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Reinforcement Learning", "MoE", "FP8", "INT4", "Enterprise", "SGLang", "Megatron-LM"]
skillDeps: ["sglang-router>=0.2.3", "ray", "torch>=2.0.0", "transformers>=4.40.0"]
---
