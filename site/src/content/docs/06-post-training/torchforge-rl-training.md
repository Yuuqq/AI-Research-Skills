...
skillName: "torchforge-rl-training"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Reinforcement Learning", "PyTorch", "GRPO", "SFT", "Monarch", "TorchTitan", "Meta"]
skillDeps: ["torch>=2.9.0", "torchtitan>=0.2.0", "vllm", "monarch"]
---
