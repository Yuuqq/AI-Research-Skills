...
skillName: "stable-diffusion-image-generation"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Image Generation", "Stable Diffusion", "Diffusers", "Text-to-Image", "Multimodal", "Computer Vision"]
skillDeps: ["diffusers>=0.30.0", "transformers>=4.41.0", "accelerate>=0.31.0", "torch>=2.0.0"]
---
