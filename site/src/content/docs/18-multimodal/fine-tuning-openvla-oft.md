...
skillName: "fine-tuning-openvla-oft"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["OpenVLA", "OpenVLA-OFT", "VLA", "Robotics", "Fine-Tuning", "LIBERO", "ALOHA", "LoRA", "FiLM", "Action Chunking", "Deployment", "Continuous Actions"]
skillDeps: ["[torch==2.2.0, transformers>=4.40.0, peft==0.11.1, draccus==0.8.0, accelerate>=0.25.0, wandb>=0.16.0, fastapi>=0.100.0, uvicorn>=0.24.0, tensorflow==2.15.0, robosuite==1.4.0]  # Exact pins: OpenVLA-OFT paper results were validated on torch==2.2.0, peft==0.11.1, tensorflow==2.15.0; upgrading torch may require re-tuning the LoRA adapter merge step and re-validating action head outputs"]
---
