...
skillName: "fine-tuning-serving-openpi"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["OpenPI", "Physical Intelligence", "VLA", "Robotics", "JAX", "PyTorch", "Fine-Tuning", "Policy Serving", "ALOHA", "DROID", "LIBERO", "pi0"]
skillDeps: ["uv>=0.4.0", "jax>=0.4.30", "torch>=2.1.0", "transformers>=4.53.2"]
---
