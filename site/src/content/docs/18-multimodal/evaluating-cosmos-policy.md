...
skillName: "evaluating-cosmos-policy"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Cosmos Policy", "VLA", "Robotics", "LIBERO", "RoboCasa", "Simulation", "Evaluation", "Profiling", "EGL Rendering"]
skillDeps: ["torch>=2.1.0", "mujoco>=3.0.0", "robosuite>=1.4.0", "robocasa @ git+https://github.com/moojink/robocasa-cosmos-policy.git", "transformers>=4.40.0", "cosmos-policy @ git+https://github.com/NVlabs/cosmos-policy.git"]
---
