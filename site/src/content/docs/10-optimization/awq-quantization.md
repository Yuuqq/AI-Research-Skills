...
skillName: "awq-quantization"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Optimization", "AWQ", "Quantization", "4-Bit", "Activation-Aware", "Memory Optimization", "Fast Inference", "vLLM Integration", "Marlin Kernels"]
skillDeps: ["autoawq", "transformers>=4.45.0", "torch>=2.0.0"]
---
