...
skillName: "pyvene-interventions"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Causal Intervention", "pyvene", "Activation Patching", "Causal Tracing", "Interpretability"]
skillDeps: ["pyvene>=0.1.8", "torch>=2.0.0", "transformers>=4.30.0"]
---
