...
skillName: "nnsight-remote-interpretability"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["nnsight", "NDIF", "Remote Execution", "Mechanistic Interpretability", "Model Internals"]
skillDeps: ["nnsight>=0.5.0", "torch>=2.0.0"]
---
