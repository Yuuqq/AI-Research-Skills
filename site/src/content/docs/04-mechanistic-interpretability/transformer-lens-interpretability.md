...
skillName: "transformer-lens-interpretability"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Mechanistic Interpretability", "TransformerLens", "Activation Patching", "Circuit Analysis"]
skillDeps: ["transformer-lens>=2.0.0", "torch>=2.0.0"]
---
