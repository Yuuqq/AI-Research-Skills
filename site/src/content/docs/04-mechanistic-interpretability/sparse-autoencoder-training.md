...
skillName: "sparse-autoencoder-training"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Sparse Autoencoders", "SAE", "Mechanistic Interpretability", "Feature Discovery", "Superposition"]
skillDeps: ["sae-lens>=6.0.0", "transformer-lens>=2.0.0", "torch>=2.0.0"]
---
