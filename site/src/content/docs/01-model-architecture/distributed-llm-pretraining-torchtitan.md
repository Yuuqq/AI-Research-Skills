...
skillName: "distributed-llm-pretraining-torchtitan"
skillVersion: "1.0.0"
skillAuthor: "Orchestra Research"
skillLicense: "MIT"
skillTags: ["Model Architecture", "Distributed Training", "TorchTitan", "FSDP2", "Tensor Parallel", "Pipeline Parallel", "Context Parallel", "Float8", "Llama", "Pretraining"]
skillDeps: ["torch>=2.6.0", "torchtitan>=0.2.0", "torchao>=0.5.0"]
---
