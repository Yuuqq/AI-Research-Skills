...
skillName: "evolving-ai-agents"
skillVersion: "1.0.0"
skillAuthor: "A-EVO Lab"
skillLicense: "MIT"
skillTags: ["Agent Evolution", "Self-Improving Agents", "Prompt Optimization", "LLM", "Benchmark Evaluation", "Skill Discovery", "Agentic AI"]
skillDeps: ["a-evolve>=0.1.0", "pyyaml>=6.0"]
---
