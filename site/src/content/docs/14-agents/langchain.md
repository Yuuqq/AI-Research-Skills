...
skillLicense: "MIT"
skillTags: ["Agents", "LangChain", "RAG", "Tool Calling", "ReAct", "Memory Management", "Vector Stores", "LLM Applications", "Chatbots", "Production"]
skillDeps: ["langchain", "langchain-core", "langchain-openai", "langchain-anthropic"]
---
